...
function checkGuess(guessedgame) {
    ...
    if (guessedgame.title === game.title) {
        ...
        feedback.textContent = `Parabéns! Você acertou: ${game.title}`; // Atualiza o texto de feedback.
        ...
        feedback.textContent = `Você Perdeu! O jogo era: ${game.title}`; // Atualiza o texto de feedback.
...
function giveUp() {
    ...
    const feedback = document.getElementById('feedback'); // Obtém o elemento de feedback.
    feedback.textContent = `Você desistiu! O jogo era: ${game.title}`; // Atualiza o texto de feedback com a resposta correta.
