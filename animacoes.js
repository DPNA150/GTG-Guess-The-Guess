...
function checkGuess(guessedanimacao) {
    ...
    if (guessedanimacao.title === animacao.title) {
        ...
        feedback.textContent = `Parabéns! Você acertou: ${animacao.title}`; // Atualiza o texto de feedback.
        ...
        feedback.textContent = `Você Perdeu! O filme era: ${animacao.title}`; // Atualiza o texto de feedback.
...
function giveUp() {
    ...
    const feedback = document.getElementById('feedback'); // Obtém o elemento de feedback.
    feedback.textContent = `Você desistiu! O filme era: ${animacao.title}`; // Atualiza o texto de feedback com a resposta correta.
