...
function checkGuess(guessedMovie) {
    ...
    if (guessedMovie.title === movie.title) {
        ...
        feedback.textContent = `Parabéns! Você acertou: ${movie.title}`; // Atualiza o texto de feedback.
        ...
        feedback.textContent = `Você Perdeu! O filme era: ${movie.title}`; // Atualiza o texto de feedback.
...
function giveUp() {
    ...
    const feedback = document.getElementById('feedback'); // Obtém o elemento de feedback.
    feedback.textContent = `Você desistiu! O filme era: ${movie.title}`; // Atualiza o texto de feedback com a resposta correta.
