...
function checkGuess(guessedesporte) {
    ...
    if (guessedesporte.nome === esporte.nome) {
        ...
        feedback.textContent = `Parabéns! Você acertou: ${esporte.nome}`; // Atualiza o texto de feedback.
        ...
        feedback.textContent = `Você Perdeu! O esporte era: ${esporte.nome}`; // Atualiza o texto de feedback.
...
function giveUp() {
    ...
    const feedback = document.getElementById('feedback'); // Obtém o elemento de feedback.
    feedback.textContent = `Você desistiu! O filme era: ${esporte.nome}`; // Atualiza o texto de feedback com a resposta correta.
