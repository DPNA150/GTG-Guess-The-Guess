...
function checkGuess(guessedserie) {
    ...
    if (guessedserie.title === serie.title) {
        ...
        feedback.textContent = `Parabéns! Você acertou: ${serie.title}`; // Atualiza o texto de feedback.
        ...
        feedback.textContent = `Você Perdeu! A série era: ${serie.title}`; // Atualiza o texto de feedback.
...
function giveUp() {
    ...
    const feedback = document.getElementById('feedback'); // Obtém o elemento de feedback.
    feedback.textContent = `Você desistiu! A série era: ${serie.title}`; // Atualiza o texto de feedback com a resposta correta.
